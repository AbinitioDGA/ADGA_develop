...
# get source files
F90_MAIN_SOURCES := main.f90 parameters_module.f90 vq_module.f90 kq_tools.f90 lapack_module.f90 one_particle_quant_module.f90 susc_module.f90 eom_module.f90 hdf5_module.f90
...
main.o: parameters_module.o kq_tools.o lapack_module.o one_particle_quant_module.o susc_module.o eom_module.o vq_module.o hdf5_module.o
...
susc_module.o: parameters_module.o 
one_particle_quant_module.o: lapack_module.o parameters_module.o
kq_tools.o: parameters_module.o
vq_module.o: parameters_module.o hdf5_module.o
