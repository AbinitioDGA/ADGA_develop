...
# get source files
F90_MAIN_SOURCES := main.f90 parameters_module.f90 lapack_module.f90 one_particle_quant_module.f90 susc_module.f90 eom_module.f90 kq_tools.f90
...
main.o: parameters_module.o lapack_module.o one_particle_quant_module.o susc_module.o eom_module.o kq_tools.o
vertex_chann_sym.o: hdf5_module.o
eom_module.o: parameters_module.o one_particle_quant_module.o kq_tools.o
